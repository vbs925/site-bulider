    ...
    (({ project, isGenerating, device = 'desktop', showEditorPanel = true }, ref) => {
        ...
        useImperativeHandle(ref, () => ({
            getCode: () => {
                ...
                //1. Remove our section class /attributes/outlines from all elements
                ...
                //2. Remove exacted style + script from the document
                const previewStyle = doc.getElementById('preview-style');
                if (previewStyle) previewStyle.remove();

                const previewScript = doc.getElementById('preview-script');
                if (previewScript) previewScript.remove();

                //3. Sterilize clean HDMl
