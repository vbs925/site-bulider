                        ...
                        <div className='flex flex-wrap gap-3.5'>
                            {projects.map((project) => (
                                <Link to={`/view/${project.id}`}
                                    key={project.id}
                                    target='_blank'
                                    className='relative group w-71 max-sm:mx-auto cursor-pointer bg-gray-900/60 border
                                ...
                                border-b border-gray-700'>
                                    ...
                                    <div className='p-4 text-white bg-liner-180 from-transparent group-hover:from-indigo-900 to-transparent transition-colors'>
                                        ...
                                        <div onClick={(e) => e.stopPropagation()}
                                            ...
                                            hover:bg-white/15 rounded-md transition-colours flex items-center gap-2'>
